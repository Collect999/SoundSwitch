...
# Function to plot and save Mel spectrogram
def plot_and_save_melspectrogram(S, sr, filename):
...
# Plot and save the Mel spectrograms for the templates
plot_and_save_melspectrogram(S1, sr, 'melspectrogram1.png')
plot_and_save_melspectrogram(S2, sr, 'melspectrogram2.png')
